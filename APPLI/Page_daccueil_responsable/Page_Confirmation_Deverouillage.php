...
// récupérer l'ID depuis l'URL pour le formulaire caché
...
<head>
    ...
    <link rel="stylesheet" href="Style_Page_Confirmation_Deverouillage.css">
</head>
<body>
...
<div class="container">
    ...
    <div id="confirmation-deverrouillage" class="confirmation-bloc">
        <div class="confirmation-contenu">
            ...
            <form method="POST" action="Confirmation_Deverouillage_PHP.php" class="confirmation-boutons">
