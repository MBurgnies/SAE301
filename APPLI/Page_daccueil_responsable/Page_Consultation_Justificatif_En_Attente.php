...
require 'Consultation_Justificatif_En_Attente.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <link rel="stylesheet" href="Style_Page_Consultation_Justificatif_En_Attente.css">
</head>
<body>
            ...
            <div class="details-right">
                ...
                <div class="justificatif-buttons">
                    ...
                    <? // récupérer le fichier que l'étudiant a déposé?>
                        <a href="../Page_daccueil_etudiante/<?php echo htmlspecialchars($justificatifDetails['fichier']); ?>" download class="action-button">Télécharger le justificatif</a>
                    <?php else : ?>
