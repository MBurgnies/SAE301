        ...
        <p id="file-status">
            ...
            if (isset($_GET['status'])) {
                ...
                if ($_GET['status'] == 'success') {
                    ...
                    // On vérifie si les données du CSV sont bien stockées dans la session
                    if (isset($_SESSION['lignesLues'])) {
                        ...
                        // si la session est vide malgré le succès
                    ...
                    // On affiche le message public et générique
                    if (isset($_SESSION['import_error_public'])) {
                        ...
                        // Message par défaut si la session est vide pour une raison X
                ...
                // sinon la page est chargée sans statut
            } else {
                echo "Aucun fichier sélectionné.";
            }
            ?>
