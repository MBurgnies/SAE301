...
<head>
    ...
    <link rel="stylesheet" href="Style_Page_Deposer_Justificatif.css">
</head>
<body>
...
<div class="header-main">
    ...
    <div class="header-right">
        ...
        <a href="../Page_de_connexion/Page_De_Connexion.php" class="button">Déconnexion</a>
    </div>
</div>
...
<div class="container">
    ...
    <form method="post" action="Deposer_Justificatif.php" id="deposerJustificatif" enctype="multipart/form-data">
